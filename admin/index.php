...
$alpinejs = "<script defer src='https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js' defer></script>";
...
$html = str_replace('</head>', $quillCss.'</head>', $html);
$html = str_replace('</body>', $quillJs.'</body>', $html);
$html = str_replace('</head>', $alpinejs.'</head>', $html);
